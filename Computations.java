...
public class Computations {
    ...
    @NotNull ChromosomeSelection grayToDecimal(@NotNull ChromosomeSelection gray) {
        String grayString;
    ...
    @NotNull ChromosomeSelection grayToBinary(@NotNull ChromosomeSelection gray, int bound) {
